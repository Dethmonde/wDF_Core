				...
				?>
					<div class="bdt-navigation-wrap bdt-position-bottom-left">
						<div class="bdt-navigation-prev">
							...
							<span class="bdt-n-p-text bdt-prev"><?php esc_html_e('Пред', 'bdthemes-prime-slider'); ?></span>
						</div>
						<div class="bdt-navigation-next">
							<span class="bdt-n-p-text bdt-next"><?php esc_html_e('След', 'bdthemes-prime-slider'); ?></span>
